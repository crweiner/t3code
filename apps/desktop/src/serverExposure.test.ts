...
describe("resolveDesktopServerExposure", () => {
  ...
  it("creates a network endpoint when network-accessible mode resolves a LAN address", () => {
    expect(
      resolveDesktopServerExposure({
  ...
  it("falls back to loopback when network-accessible mode has no reachable address", () => {
    expect(
      resolveDesktopServerExposure({
        mode: "network-accessible",
        port: 3773,
