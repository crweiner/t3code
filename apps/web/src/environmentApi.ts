...
export function createEnvironmentApi(rpcClient: WsRpcClient): EnvironmentApi {
  return {
    ...
    nilus: {
      ...
      preparePartnerDraft: rpcClient.nilus.preparePartnerDraft,
      createPartner: rpcClient.nilus.createPartner,
      preparePartnerUpdate: rpcClient.nilus.preparePartnerUpdate,
      updatePartner: rpcClient.nilus.updatePartner,
      prepareIssueDraft: rpcClient.nilus.prepareIssueDraft,
      createIssue: rpcClient.nilus.createIssue,
      prepareIssueUpdate: rpcClient.nilus.prepareIssueUpdate,
      updateIssue: rpcClient.nilus.updateIssue,
    },
    git: {
